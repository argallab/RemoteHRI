...
export default class DiscreteGridWorldModes extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        var json = this.props.data // passed from Content.js as the data property tag
